...
",body_text);
    ...
    public bool SendEmail(string strTo, string strCcList, string strBccList, string strSubject, string strBody, bool IsBodyHtml)
    {
        ...
        objEmail.From = new MailAddress("jagadishbaji@gmail.com", strFrom);
        ...
        try
        {
            smtpSendMail.Credentials = new System.Net.NetworkCredential("jagadishbaji@gmail.com", "8884856868");
