<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view-doctors.aspx.cs" Inherits="Patient_view_doctors" %>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">View all Doctors</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">Doctors list</h4>
